        ...
        <div className='w-full bg-[url("/bg-1.png")] ' >
            ...
            <div className="flex flex-col justify-center gap-8 w-full mt-36 px-10 text-center">
                ...
                <div className="flex flex-col items-center gap-4 text-sm mt-6" >
                    <h2 className="p-3 w-1/2  bg-muted rounded-full" >✅  Unlimited Chats</h2>

                    <h2 className="p-3  w-1/2   bg-muted rounded-full" >🔐  Secure</h2>

                    <h2 className="p-3  w-1/2  bg-muted rounded-full" >🧩 Biggest Library of Connectors</h2>
                </div>
            </div>
        </div>
    )
